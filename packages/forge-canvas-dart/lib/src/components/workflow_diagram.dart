...
///
/// Nodes and edges are typed against the sealed
/// [WorkflowDiagramNode] / [WorkflowDiagramEdge] classes generated by
/// ``forge.codegen.canvas_props``. The hand-written ``_WfNode`` /
/// ``_WfEdge`` mirror classes are gone — the generated file is the
