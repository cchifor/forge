...
class Settings(BaseSettings):
    ...
    def _bootstrap_log(
        ...
        """
        A lightweight logger for the bootstrap phase before the main logger is configured.
        """
    ...
    def settings_customise_sources(
        ...
        # 3. Define sources in priority order (First = Highest)
        standard_sources = (
            env_settings,
        ...
        # 4. Wrap in ReferenceResolvingSettingsSource
        return (
            init_settings,
