...
# CandidatePatch construction-time codes (Initiative #1 sub-task 2 follow-up).
# Distinct from the FRAGMENT_INJECT_YAML_* codes because these fire on bundle
# deserialization or plugin-extractor output, not on malformed inject.yaml.
CANDIDATE_PATCH_BAD_KIND = "CANDIDATE_PATCH_BAD_KIND"
CANDIDATE_PATCH_BAD_RISK = "CANDIDATE_PATCH_BAD_RISK"
...
# FeatureManifest codes (PluginError subgroup)
FEATURE_MANIFEST_MISSING = "FEATURE_MANIFEST_MISSING"
FEATURE_MANIFEST_INVALID = "FEATURE_MANIFEST_INVALID"
FEATURE_DEPENDENCY_MISSING = "FEATURE_DEPENDENCY_MISSING"
FEATURE_DEPENDENCY_CYCLE = "FEATURE_DEPENDENCY_CYCLE"
